    ...
    for tilemap_x in range(tilemap_n):
        for tilemap_y in range(tilemap_m):
            ...
            # === 5 tile_pos_x ===
                ...
                tile_info[5] = ((tilemap_y*(C.tile_size/2)-tilemap_x*(C.tile_size/2))+C.move_x)*(1280/(16*C.game_main_surface_level))

            # === 6 tile_pos_y ===

                tile_info[6] = ((tilemap_y*(C.tile_size/4)+tilemap_x*(C.tile_size/4))+C.move_y)*(1280/(16*C.game_main_surface_level))
