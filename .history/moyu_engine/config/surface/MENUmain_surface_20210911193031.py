...
def background(): 
    ...
    background_surface.blit(G.menu_backgroundFin, (0,0)).convert_alpha()
...
def gui(): 
    ...
    gui_surface.blit(G.button001_unclickFin, (C.WINDOW_SIZE[0]-64*3*1 - 20, C.WINDOW_SIZE[1]-16*3*5 - 10*5)).convert_alpha()
    startbutton_text = F.font1.render('新游戏', True, (255, 255, 255))
    gui_surface.blit(startbutton_text,(C.WINDOW_SIZE[0]-64*2.5*1, C.WINDOW_SIZE[1]-16*2.87*5 - 10*5)).convert_alpha()

    gui_surface.blit(G.button001_unclickFin, (C.WINDOW_SIZE[0]-64*3*1 - 20, C.WINDOW_SIZE[1]-16*3*4 - 10*4)).convert_alpha()
    startbutton_text = F.font1.render('继续', True, (255, 255, 255))
    gui_surface.blit(startbutton_text,(C.WINDOW_SIZE[0]-64*2.5*1, C.WINDOW_SIZE[1]-16*2.87*4 - 10*4)).convert_alpha()

    gui_surface.blit(G.button001_unclickFin, (C.WINDOW_SIZE[0]-64*3*1 - 20, C.WINDOW_SIZE[1]-16*3*3 - 10*3)).convert_alpha()
    startbutton_text = F.font1.render('设置', True, (255, 255, 255))
    gui_surface.blit(startbutton_text,(C.WINDOW_SIZE[0]-64*2.5*1, C.WINDOW_SIZE[1]-16*2.87*3 - 10*3)).convert_alpha()

    gui_surface.blit(G.button001_unclickFin, (C.WINDOW_SIZE[0]-64*3*1 - 20, C.WINDOW_SIZE[1]-16*3*2 - 10*2)).convert_alpha()
    startbutton_text = F.font1.render('退出', True, (255, 255, 255))
    gui_surface.blit(startbutton_text,(C.WINDOW_SIZE[0]-64*2.5*1, C.WINDOW_SIZE[1]-16*2.87*2 - 10*2)).convert_alpha()

    gui_surface.blit(G.button001_unclickFin, (C.WINDOW_SIZE[0]-64*3*1 - 20, C.WINDOW_SIZE[1]-16*3*1 - 10*1)).convert_alpha()
    startbutton_text = F.font1.render('关于', True, (255, 255, 255))
    gui_surface.blit(startbutton_text,(C.WINDOW_SIZE[0]-64*2.5*1, C.WINDOW_SIZE[1]-16*2.87*1 - 10*1)).convert_alpha()
